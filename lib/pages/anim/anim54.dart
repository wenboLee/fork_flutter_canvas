...
class Anim54Page extends StatefulWidget {
  final String title;

  Anim54Page({Key? key, required this.title}) : super(key: key);

  @override
  _Anim54PageState createState() => _Anim54PageState();
}

class _Anim54PageState extends State<Anim54Page>
  ...
  void _springTo(Ball ball1, Ball ball2) {
    ...
    //向心缓动
    var vx = (_size.width / 2 - ball1.x) * easing;
    var vy = (_size.height / 2 - ball1.y) * easing;
